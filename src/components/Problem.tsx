...
const cards: Card[] = [
  {
    ...
    description2:
      'Global financial crime results in annual losses exceeding trillions, impacting both public and private sectors. Businesses face growing costs for compliance and recovery, while citizens suffer economic and social consequences...',
  ...
  },
  {
    ...
    description2:
      'Being greylisted by the Financial Action Task Force brings reputational risks, increased scrutiny, and global financial constraints...',
  ...
  },
  {
    ...
    description2:
      'Cybercriminals now leverage AI, blockchain, and cross-border laundering to evade detection. Traditional defenses are reactive and slow...',
  ...
  return (
    <>
      ...
      {activeCard && (
        ...
        >
          <div
            className="bg-gray-900 p-10 rounded-3xl max-w-3xl w-full mx-6 relative border-l-4 border-red-500 text-left overflow-y-auto max-h-[90vh]"
