  ...
  return (
    ...
    >
      <div className="container mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-12 gradient-text bg-gradient-to-r from-blue-400 to-indigo-500 text-transparent bg-clip-text">
